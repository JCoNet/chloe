...
module.exports.run = async (bot, message, args, connection) => {
  ...
  let defaultChannel = await message.guild.channels.cache.find(channel => channel.type === 'text' && channel.permissionsFor(message.guild.me).has('SEND_MESSAGES')).catch(err => console.log(err));
