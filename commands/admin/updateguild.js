module.exports = {
  ...
  async execute(Discord, bot, connection, message, args, useprefix) {
    ...
    if(!message.member.permissions.has("ADMINISTRATOR")) return message.channel.send(`<@!${message.author.id}>, This command due to it's nature can only be run by a guild admin.`);
