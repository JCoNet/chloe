module.exports = {
    ...
    async execute(Discord, bot, connection, message, args, useprefix) {
        ...
        if(!message.member.permissions.has("ADMINISTRATOR")) return message.channel.send(`Unfortunately <@!${message.author.id}>, under JCoNet operation policies i am not allowed to let anyone not ranked with permission ADMINISTRATOR to change any of my settings for servers.`);
